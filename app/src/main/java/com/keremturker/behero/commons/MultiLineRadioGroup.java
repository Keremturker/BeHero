...
public class MultiLineRadioGroup extends RadioGroup {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            int color = typedArray.getColor(R.styleable.multi_line_radio_group_tintColor, 0);
     ...
     */
    public void addButtons(int color, CharSequence... radioButtons) {
        addButtons(-1, color, radioButtons);
    }
     ...
     */
    public void addButtons(int index, int color, CharSequence... radioButtons) {
